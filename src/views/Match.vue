                ...
                <div class="center-game_list" v-if="!loading && details">
                    ...
                    <div v-if="!live">
                        <div v-for="(i, o) in details.markets" :key="o">
                            <div class="card-body text-start" v-if="i.status">
                                <h6 class="fw-bolder">{{ i.market_name }}</h6>
                                <div >
                                    <div class="bets" :class="(i.selections.length % 2) === 0 ? 'bets-2': 'bets-3' ">
                                        <div class="bet" v-for="(x,y) in i.selections" :key="y">
                                            <div class="anchor-wrap column">
                                                <span class="event_selection" v-if="x.active == '1'">
                                                    {{ x.name }}
                                                </span>
                    ...
                    <div v-if="live">
                        <div v-for="(i, o) in details.live_data?.markets" :key="o">
                            <div class="card-body text-start" v-if="i.active == '1'">
                                ...
                                <div >
                                    <div class="bets" :class="(i.odds.length % 2) === 0 ? 'bets-2': 'bets-3' ">
                                        <div class="bet" v-for="(x,y) in i.odds" :key="y">
                                            <div class="anchor-wrap column">
                                                <span class="event_selection text-uppercase" v-if="x.active == '1'">
                                                    {{ x.type }}
                                                </span>
                                                <span class="event_odds" v-if="x.active == '1'">
                                                    {{ x.odds }}
