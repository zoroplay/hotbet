                ...
                <div class="center-game_list betlist">
                    <div class="card bg-transparent rounded-0 border-0 rounded-0">
                        ...
                        <div class="card-header text-start page_headline py-3">
                            <router-link to="/bets/open" class="text-decoration-none me-3 text-white fw-bolder">Open</router-link>
                            ...
                            <router-link to="/bets/virtuals" class="text-decoration-none me-3 virtuals fw-bolder">Virtuals</router-link>
                        </div>
...
<style>
.betlist .virtuals.router-link-exact-active.router-link-active{
    color: #04a7f8;
    font-weight: 800;
}
</style>