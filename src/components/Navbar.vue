    ...
    <div class="header">
        <div class="main d-flex justify-content-between align-items-center px-3 py-3 bg-transparent">
            ...
            <div v-if="!isLoggedIn" class="btn-group" role="group" aria-label="Basic example">
                <router-link to="/Login" class="btn bg-transparent text-white text-uppercase fw-bold">LOGIN</router-link>
                <router-link to="/Register" class="btn btn-success align-items-center btn-sm text-uppercase fw-bold">join now</router-link>
