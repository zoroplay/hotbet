    ...
    <b-sidebar id="betslip-menu" sidebar-class="overflow-hidden" backdrop no-header shadow right>
        <div class="right-content">
            ...
            <div class="right-bet_container">
                <div class="nav nav-tabs nav-justified border-0" id="nav-tab" role="tablist">
                    <button class="nav-link active py-3 border-0 rounded-0" id="nav-home-tab" data-bs-toggle="tab"
                        data-bs-target="#nav-home" type="button" role="tab" aria-controls="nav-home"
                        aria-selected="true">
                        Sport ({{ betslip.selections.length }})
                    </button>
                    <button class="nav-link rounded-0 py-3 border-0" id="nav-profile-tab" data-bs-toggle="tab"
                ...
                <div class="tab-content" id="nav-tabContent">
                    <div class="tab-pane show active py-3" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                        <div class="px-3" v-if="betslip.selections.length < 1">
                            <div class="d-flex">
                                <input type="text" class="form-control rounded-0" id="inputPassword2" placeholder="" />
                            ...
                            <svg class="svg-icon" style="vertical-align: middle;">
                                ...
                                <use xmlns:xlink="http://www.w3.org/1999/xlink"
                                    xlink:href="/img/icons.c4f70481.svg#empty-betslip"></use>
                            </svg>
                        </div>
                        <div v-else>
                            <div>
                                <div class=" d-flex mb-3 justify-content-between align-items-center">
                                    ...
                                    <span class="text-underline btn btn-link text-white"
                                        @click.prevent="clearBetslip">Clear Betslip</span>
                                </div>
                                <div v-for="(bet, index) in betslip.selections" :key="index"
                                    ...
                                    <div class="text-start card-body p-0">
                                        <div class="d-flex align-items-center betslip-bet">
                                            ...
                                            <div class="btslip-game px-3 w-100">
                                                ...
                                                }" class="small text-white">{{ bet.event_name }}</router-link>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="text-start py-3 px-2">
                                    <div class="ps-0 form-check mb-3">
                                        <input class="me-3" type="checkbox" value="" id="flexCheckDefault" />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="" id=""
                                            class="form-control rounded-0 bg-transparent text-white" placeholder=""
                                            aria-describedby="helpId" />
                                        <small id="helpId" class="text-muted">Min stake is 1</small>
                                    </div>
                                    <div class="d-flex text-white-50 justify-content-between align-items-center py-2">
                                        <span>Odds</span>
                    ...
                    <div class="tab-pane" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                        <p>Betslip is empty</p>
                        <svg data-v-0739479d="" data-v-848acb24="" class="svg-icon" style="vertical-align: middle;">
                            <!---->
                            <use data-v-0739479d="" xmlns:xlink="http://www.w3.org/1999/xlink"
                                xlink:href="/img/icons.c4f70481.svg#empty-betslip"></use>
                        </svg>
                    </div>
                </div>
